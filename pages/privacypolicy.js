...
export default function PrivacyPolicy() {
    return (
        <div>
            <Head>
                <title>Lynshia | Privacy Policy</title>
                <meta name="description"
                    content="Our Privacy Policy governs your visit to https://lynshia.netlify.app/, and explains how we collect, safeguard and disclose information that results from your use of our Service." />
                <meta name="keywords"
            ...
            <div className={`${styles.pblbanner} ${styles.privp} vflex`}>
                <h1>Privacy Policy</h1>
            </div>
            <div className={`${styles.privpol} vflex`}>
